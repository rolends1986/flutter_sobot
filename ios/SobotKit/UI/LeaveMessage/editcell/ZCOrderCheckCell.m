...
//    [_labelName setText:dict[@"dictDesc"]];
    ...
    CGPoint imgC = _imgArrow.center;
    imgC.y = self.frame.size.height/2;
    _imgArrow.center = imgC;
    
    CGPoint ContentC = _labelContent.center;
    ContentC.y = self.frame.size.height/2;
    _labelContent.center = ContentC;
