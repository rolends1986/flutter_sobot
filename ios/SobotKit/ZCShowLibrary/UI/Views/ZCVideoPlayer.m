...
-(void)showControlsView{
    ...
    [_labStartTime setFont:ListTimeFont];
    [_labStartTime setTextColor:UIColorFromRGB(TextWhiteColor)];
    ...
    [_labEndTime setFont:ListTimeFont];
    [_labEndTime setTextColor:UIColorFromRGB(TextWhiteColor)];
    ...
    _sliderProgress.tintColor = UIColorFromRGB(TextWhiteColor);
    _sliderProgress.minimumTrackTintColor = UIColorFromRGB(TextWhiteColor); // 已走过
    _sliderProgress.maximumTrackTintColor = UIColorFromRGB(0x6E6E6E); // 未走过
    _sliderProgress.thumbTintColor = UIColorFromRGB(TextWhiteColor);        // 滑块颜色
    _sliderProgress.minimumValue = 0;
    _sliderProgress.maximumValue = 1;
    
    UIImage *img = [ZCUIImageTools zcimageWithColor:UIColorFromRGB(TextWhiteColor)];
...
-(UIView *) getTipsView{
    if(!_tipsView){
        ...
        [lab1 setTextColor:UIColorFromRGB(TextNameColor)];
        [lab1 setFont:ListTitleFont];
        [lab1 setText:@"播放失败"];
        [_tipsView addSubview:lab1];
        
        UILabel *lab2 = [[UILabel alloc] initWithFrame:CGRectMake(0, 40, 220, 24)];
        [lab2 setTextColor:UIColorFromRGB(TextTimeColor)];
        [lab2 setFont:ListDetailFont];
        [lab2 setText:@"视频文件损坏，无法播放"];
