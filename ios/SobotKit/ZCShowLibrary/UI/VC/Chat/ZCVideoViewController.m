...
-(void)setupView{
    ...
    [_btnCamera setFrame:CGRectMake(ScreenWidth - 64,StatusBarHeight, 44, 44)];
    ...
    _progressView.tintColor = [ZCUITools zcgetDynamicColor];
    _progressView.borderWidth = 0;
    [_progressView setBackgroundColor:UIColorFromRGB(0xCBC7C7)];
    ...
    [_labelTipTitle setTextColor:UIColorFromRGB(TextWhiteColor)];
    [_labelTipTitle setTextAlignment:NSTextAlignmentCenter];
    [_labelTipTitle setFont:ListDetailFont];
