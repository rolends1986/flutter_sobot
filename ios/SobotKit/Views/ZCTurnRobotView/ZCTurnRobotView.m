...
- (void)createSubviews{
    ...
    [titleLabel setText:ZCSTLocalString(@"选择要咨询的业务")];
...
-(UIButton *)addItemView:(ZCLibRobotSet *) model withX:(CGFloat )x withY:(CGFloat) y withW:(CGFloat) w withH:(CGFloat) h{
    ...
    [itemView setBackgroundImage:[ZCUIImageTools zcimageWithColor:UIColorFromRGB(0xFFFFFF)] forState:UIControlStateNormal];
    [itemView setBackgroundImage:[ZCUIImageTools zcimageWithColor:UIColorFromRGB(0x0daeaf)] forState:UIControlStateHighlighted];
     [itemView setBackgroundImage:[ZCUIImageTools zcimageWithColor:UIColorFromRGB(0x0daeaf)] forState:UIControlStateSelected];
    ...
    [itemView setTitleColor:UIColorFromRGB(0xffffff) forState:UIControlStateHighlighted];
    [itemView setTitleColor:UIColorFromRGB(0xffffff) forState:UIControlStateSelected];
