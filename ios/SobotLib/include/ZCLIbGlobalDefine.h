...
// iPhoneX
#define ZC_iPhoneX (((SysScreenWidth == 375.f && SysScreenHeight == 812.f ) || (SysScreenWidth == 414.f && SysScreenHeight == 896.f ))? YES : NO)
...
NSString * Bpath = [bundlePath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@_lproj",languages]];\
NSBundle *resourceBundle = [NSBundle bundleWithPath:Bpath];\
if(!resourceBundle){\
Bpath = [bundlePath stringByAppendingPathComponent:@"Base_lproj"];\
resourceBundle = [NSBundle bundleWithPath:Bpath];\
}\
